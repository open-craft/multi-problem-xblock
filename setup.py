...
VERSION = get_version('multi_problem_xblock', '__init__.py')
...
setup(
    name='multi-problem-xblock',
    version=VERSION,
    description='Multi Problem XBlock',
    ...
    url='https://github.com/open-craft/multi-problem-xblock',
    install_requires=load_requirements('requirements/base.in'),
    entry_points={
        'xblock.v1': ['multi_problem = multi_problem_xblock:MultiProblemBlock'],
    },
